...
shinyUI(
  navbarPage(theme = shinytheme("united"),
             ...
             tabPanel("Question",
                      fluidRow(align = "center", # World map selector and focus country
                               ...
                               column(10, align = "left",
                                      generateAlert("danger", "Plese not this app is still under active development and only shows preliminary data and ideas."),
                                      h1("How can we evaluate global progress?"),
                                      p("Governments have been using economic groth as a material measure to inform policy making and assessment. While increasing economic results has brought wealth, we are also being confronted with detrimental side effects like climate change.")),
                               column(1)
                      ),
                      fluidRow(
                               column(1),
                               column(5,
                                      h3("Economic view"),
                                      plotlyOutput("econ_view")),
                               column(5,
                                      h3("Ecological perspective"),
                                      plotlyOutput("eco_view")),
                               column(1)
                               ),
                      fluidRow(
                        column(1),
                        column(10,
                               h2("Can we shift to an integrated paradigm?"),
                               p("Alternative performance indexes have been created to provide more nuanced views. This site gives you an ", actionLink("link_to_history_tab", "overview of metrices"), " and explores ", actionLink("link_to_biomimicry_tab", "strategies from nature"), "to develop an integrated metric that pursues condition conducive to good life for mankind and the rest of nature.")),
                        column(1)
                      )),
             navbarMenu("Review ",
                        ...
                        tabPanel("Compare metrics by country",
             ...
             #                   p("Result")),
             #            column(1)
             #          )), # End of navbarMenu "Analyses
             navbarMenu("Natural Progress?",
             ...
             ), # End of navbarMenu "Ntural Progress?"
             navbarMenu("About",
                        tabPanel("Objectives",
                                 fluidRow(
                                   column(1),
